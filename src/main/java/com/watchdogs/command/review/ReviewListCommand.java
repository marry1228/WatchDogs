...
//		String userid = request.getParameter("userid");	//hidden으로 값이 오나?
...
//				int end = clickPage * numInAPage;
			...
			if(searchCategory == null || searchCategory.isEmpty()) {
				searchCategory = "all"; //첫번째 목록 (전체페이지)
			}
			 ...
			 */
			ArrayList<ReviewDto> dtos = dao.reviewList(clickPage, numInAPage, searchCategory, searchWord); // 해당 페이지에 알맞은 번호의 게시글
