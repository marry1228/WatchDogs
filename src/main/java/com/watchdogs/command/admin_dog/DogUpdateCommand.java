	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		// 실제 파일 업로드하는 과정
	  	try{
	    	...
	    	int dogId = Integer.parseInt(multi.getParameter("dogId"));
	    	...
	    	String dogAdoptSt = multi.getParameter("dogAdoptSt");
	    	String dogDate = multi.getParameter("dogDate");
	    	String dogAdoptDate = multi.getParameter("dogAdoptDate");
	    	...
	    	daoDog.update(dogId, dogName, dogType, dogMF, dogAge, dogAdoptSt, dogDate, dogAdoptDate, dogTrainComm, adminID, trainerID, dogFilePath);
