	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		// 실제 파일 업로드하는 과정
	  	try{
	    	...
	    	String trDate = multi.getParameter("trDate");
	    	String trDelDate = multi.getParameter("trDelDate");
	    	...
	    	daoTrainer.update(trId, trPw, trEmail, trTel, trName, trCareer, trDate, trDelDate, adminID, trFilePath);
