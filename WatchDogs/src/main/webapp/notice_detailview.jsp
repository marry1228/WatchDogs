...
<!--  줄 ---------------------------------------->
	...
	<!-- 테이블 시작 ---------------------------------------->
	 <table border="1" width="700" >
			<thead>
				<tr>
					<th colspan="4" style="background-color: #FFCD28; text-align: center; font-size:18px;">공지 상세 페이지</th>
				</tr>
			</thead>
			...
			<tr>
				<td colspan="4" style="text-align: right;"><a href = "noticelist.wd">목록으로</a></td>
			</tr>	
			
			<tr>			
				<td colspan="4"><button type="button" style=" background:#FFCD28; font-size:15px;" onclick="location.href='noticelist.wd'">확인</button></td>		
			</tr>
