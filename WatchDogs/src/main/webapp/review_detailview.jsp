...
<!-- 테이블 시작---------------------------------------->
	 <table border="1"  width="700" >
	 	<input type="hidden" name="reid" value="${reviewdetail.reid}">
			<thead>
				<tr>
					<th colspan="4" style="background-color: #FFCD28; text-align: center; font-size:18px;">후기 상세 페이지</th>
				</tr>
			</thead>
			<tbody>
			...
			<tr>
				<td>사진</td>
				<td colspan="3"><img width="300" src="review/${reviewdetail.refilepath }"></td>
			</tr> 
