	 ...
	 <table border="1" width="700" >
		 <form action="reviewmodify.wd" method="post" enctype="multipart/form-data" >
		 	<input type="hidden" name="reid" value="${reviewdetail.reid}">
				<thead>
					<tr>
						<th colspan="4" style="background-color: #FFCD28; text-align: center; font-size:18px;">후기 수정 페이지</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr>
						<td>사진</td>
						<td colspan="3"><img class="imgClass" width="300"  src="review/${reviewdetail.refilepath }"></td>
					</tr> 
					...
					<tr>
						<td colspan="4"><input type="submit" style=" background:#FFCD28; font-size:15px; " value="수정">
							<input type="button" class="button" style=" background:#FFCD28; font-size:15px; "  onclick="location.href='reviewdelete.wd?reid=${reviewdetail.reid}'"  value="삭제">
						</td>
					</tr>
			</form>
	</table> 
