	...
	<h3>회원 정보</h3>
		<form action="userUpdate.wd" method="post">
			<input type="hidden" name="userId" value="${detail.userId }">
				...
				이메일<input type="text" name="userPw" size="20" value="${detail.userPw}"><br>
				전화번호<input type="text" name="userTel" size="50" value="${detail.userTel}"><br>
				이름<input type="text" name="userEmail" size="50" value="${detail.userEmail}"><br>
				등록날짜<input type="text" name="userName" size="50" value="${detail.userName}"><br>
				삭제날짜<input type="text" name="userDate" size="50" value="${detail.userDate}"><br>
